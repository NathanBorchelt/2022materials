...
public class Browser {
	public Browser(){
		String url = "https://www.google.com/maps/@36.6136021,-88.3251097,15.5z";
        ...
        if(Desktop.isDesktopSupported()){
            ...
            try {
            	//for(int z=0;z<5;z++){//take screenshots at different altitudes
            		for(int y=0;y<3;y++){
            			for(int x=0;x<3;x++){
            				url = "https://www.google.com/maps/@"+longitude+","+lattitude+","+altitude+"z";
            				desktop.browse(new URI(url));
            				TimeUnit.SECONDS.sleep(2);//delay to have enough time for it to load, but not enough time to load the crap
            				captureScreen(longitude+"_"+lattitude+"_"+altitude+".png",altitude);//save screenshot to file
            				longitude+=0.1;
            			}
            			lattitude+=0.00001;
            		}
